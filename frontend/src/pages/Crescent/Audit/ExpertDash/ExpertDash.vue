<template>
    <div>
        ...
        <b-modal id="show-expert-result" scrollable hide-footer title="专审结果">
            <vue-form-generator :schema="form.expertAuditResult.schema" :model="form.expertAuditResult.model" />
            <div class="w-100 d-flex justify-content-center">
                <b-button squared variant="outline-success" class="mt-2">转入立项</b-button>
            </div>
        </b-modal>
        <b-modal id="show-expert-account" scrollable hide-footer title="当前课题外审账号">
            <vue-form-generator ref="accountVFG" :schema="form.expertAccount.schema"
                                :model="form.expertAccount.model" :options="form.options" />
            ...
            <b-list-group class="border p-2">
                <template v-for="(item, index) in form.expertAccount.model.list">
