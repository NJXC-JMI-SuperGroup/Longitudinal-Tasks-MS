...
let resources = {
    ...
    textTooSmall: "文本长度太小！当前: {0},最小: {1}",
    textTooBig: "文本长度太大！当前: {0},最大: {1}",
    thisNotText: "这不是文本！",

    thisNotArray: "这不是数组！",

    selectMinItems: "选择最少{0}个项目！",
    selectMaxItems: "最多选择{0}个项目！",

    invalidDate: "日期无效！",
    dateIsEarly: "日期过早！当前: {0},最小值: {1}",
    dateIsLate: "日期太晚了！当前: {0},最大值: {1}",
    ...
    invalidTextContainNumber: "无效的文本！不能包含数字或特殊字符",
    invalidTextContainSpec: "无效的文本！不能包含特殊字符"
};
