<template>
    <b-list-group class="listGroup thin-scroll">
      ...
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="../../../../assets/SingApp/people/a2.jpg" alt="..."/>
      ...
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="../../../../assets/SingApp/people/a5.jpg" alt="..."/>
        <i class="status status-bottom bg-success"/>
      </span>
        ...
        <b-list-group-item class="listGroupItem">
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="../../../../assets/SingApp/people/a1.jpg" alt="..."/>
        ...
        <b-list-group-item class="listGroupItem">
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="../../../../assets/SingApp/people/a6.jpg" alt="..."/>
        ...
        <b-list-group-item class="listGroupItem">
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="../../../../assets/SingApp/people/a4.jpg" alt="..."/>
