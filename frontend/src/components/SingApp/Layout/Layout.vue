...
<script>
    ...
    import Sidebar from '@/components/SingApp/Sidebar/Sidebar';
    import Header from '@/components/SingApp/Header/Header';
    import Helper from '@/components/SingApp/Helper/Helper';
    import BreadcrumbHistory from '@/components/SingApp/BreadcrumbHistory/BreadcrumbHistory';
