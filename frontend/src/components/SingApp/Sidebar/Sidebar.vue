<template>
    <div class="sidebar-wrapper">
        ...
        >
            <header class="logo">
                <router-link to="/SingApp"><span class="primary-word">Sing</span> App</router-link>
            </header>
            <ul class="nav">
                <NavLink
                        :activeItem="activeItem"
                        header="Dashboard"
                        link="/SingApp/dashboard"
                ...
                <NavLink
                        :activeItem="activeItem"
                        header="Components"
                        link="/SingApp/components"
                        iconName="flaticon-network"
                        index="components"
                        :childrenLinks="[
              { header: 'Charts', link: '/SingApp/components/charts' },
              { header: 'Icons', link: '/SingApp/components/icons' },
              { header: 'Maps', link: '/SingApp/components/maps' },
            ]"
                />
            </ul>
            <p>
